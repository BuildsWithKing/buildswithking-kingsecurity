...
/// @title KingERC20Pausable.
/// @author Michealking (@BuildsWithKing).
/// @notice Created on the 2nd of Nov, 2025.
/// @custom:securitycontact buildswithking@gmail.com
/// @dev A pausable ERC20 core with mint and burn capability integrated with KingPausable contract.

/// @notice Imports IERC20Metadata interface, KingPausable, KingERC20Errors contract and KingCheckAddressLib Library.
import {IERC20Metadata} from ".././interfaces/IERC20Metadata.sol";
import {KingPausable} from "../../../extensions/KingPausable.sol";
import {KingERC20Errors} from "../../errors/KingERC20Errors.sol";
import {KingCheckAddressLib} from "../../../utils/KingCheckAddressLib.sol";

abstract contract KingERC20Pausable is KingPausable, IERC20Metadata, KingERC20Errors {
    // -------------------------------------------------- State Variables --------------------------------------------------
    ...
    /// @dev Sets the king, token's name, symbol, initial supply at deployment.
    ...
    /// @param to The receiver's address.
    /// @param amount The amount of token to be minted.
    function mint(address to, uint256 amount) external virtual whenActive {
    ...
    /// @param from The sender's address.
    /// @param amount The amount of tokens to be burned.
    function burnFrom(address from, uint256 amount) external virtual whenActive {
